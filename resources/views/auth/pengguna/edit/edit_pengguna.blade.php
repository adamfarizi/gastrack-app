...
@section('content')
    <div class="card-header pb-0 text-left">
        <h3 class="font-weight-bolder text-primary text-gradient">Edit Pengguna</h3>
        <p class="mb-0">Silahkan lengkapi data diri pelanggan dengan benar</p>
    </div>
    <div class="card-body">
        @if (session('success'))
        ...
        <form role="form text-left" action="" method="POST">
            ...
            <div class="input-group input-group-outline mb-3 bg-white">
                <input name="name" type="text" class="form-control" aria-label="name" value="PT. Selep Nglames">
            </div>
            <label>Email<span class="text-danger">*</span></label>
            <div class="input-group input-group-outline mb-3 bg-white">
                <input name="email" type="text" class="form-control" aria-label="email" value="agen1@example.com">
            </div>
            <label>No Hp<span class="text-danger">*</span></label>
            <div class="input-group input-group-outline mb-3 bg-white">
                <input name="no_hp" type="text" class="form-control" aria-label="no_hp" value="088111222">
            </div>
            <label>Tagihan<span class="text-danger">*</span></label>
            <div class="input-group input-group-outline mb-3 bg-white">
                <input name="tagihan" type="text" class="form-control" aria-label="tagihan" value="2.000.000">
            </div>
