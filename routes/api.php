...
Route::post('/sopir/login', [ApiSupirController::class, 'login_action']);

Route::middleware(['auth:sanctum', 'check.user:pelanggan'])->group(function () {
...
Route::middleware(['auth:sanctum', 'check.user:sopir'])->group(function () {
    Route::post('/sopir/logout', [ApiSupirController::class, 'logout']);
    Route::get('/sopir/update/{id}', [ApiSupirController::class, 'edit_index']);
});
